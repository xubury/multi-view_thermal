...
Axis::Axis(const glm::mat4 &model) : RenderTarget(model), m_VAO(0) {
    ...
    float vertices[] = {0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 1.f, 0.f, 0.f,
                        1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f,
    ...
    glVertexAttribPointer(
        0,                  // location = 0 in vertex shader file
    ...
    glVertexAttribPointer(
        1,                             // location = 1 in vertex shader file
        3,                             // the color has RGB 3 elements
        GL_FLOAT,                      // element type
        GL_FALSE,                      // do not normalize
        6 * sizeof(float),             // Stride
        (void *)(3 * sizeof(float)));  // an offset of into the array, it is 3 *
                                       // sizeof(float)
